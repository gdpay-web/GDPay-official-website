<template>
  <button class="text-[4.444vw] gd-rounded h-[14.815vw] w-[90.741vw] m-auto flex-c-c xl:h-[80px] xl:w-[490px] xl:rounded-[13px] xl:text-[24px] xl:m-0" :class="type === 'blue' ? 'bg-blue text-white' : 'bg-white text-blue'" @click="download()">
