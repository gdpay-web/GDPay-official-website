<template>
  <button
    class="text-[4.444vw] gd-rounded h-[14.815vw] w-[90.741vw] m-auto flex-c-c xl:h-[80px] xl:w-[392px] xl:rounded-[13px] xl:text-[24px] xl:m-0"
  ...
  >
    ...
    <img v-else src="images/logo-blue.png" class="w-[4.593vw] mr-[2vw]" alt="" />
    {{ title || '下载APP' }}
  </button>
</template>
<script setup>
