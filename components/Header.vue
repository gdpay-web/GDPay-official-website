  ...
  <div>
    ...
    >
      ...
      <ul class="text-[#666666] text-[21px] hidden xl:flex">
        ...
        <li
          class="ml-[44px] cursor-pointer font-medium"
    ...
    <div class="relative" v-show="visiable">
      ...
      >
        <template v-if="$route.query.from">
          <li class="leading-[11vw] under-line" :class="{ 'text-blue': $route.path === '/announcement' }" @click="goto('/announcement?from=gdpay_h5')">最新公告</li>
          <li class="leading-[11vw]" :class="{ 'text-blue': $route.path === '/assist' }" @click="goto('/assist?from=gdpay_h5')">帮助中心</li>
        </template>
        <template v-else>
          <li class="leading-[11vw] under-line" :class="{ 'text-blue': $route.path === '/' }" @click="goto('/')">GDPAY</li>
