<template>
  <div class="bg-download-bg bg-contain bg-no-repeat xl:bg-none">
    ...
    <div class="xl:w-[1200px] xl:m-auto xl:absolute xl:top-[200px] xl:left-[50%] xl:translate-x-[-50%]">
      <p class="text-blue text-[8.333vw] text-center mt-[18vw] xl:mt-0 xl:text-[63px] xl:text-left font-medium">助您安全、自由支付</p>
...
onMounted(() => {
  qrcode.toCanvas(document.getElementById('canvas'), 'https://www.gdpay8.com/download', { width: 180 }, function (error) {
