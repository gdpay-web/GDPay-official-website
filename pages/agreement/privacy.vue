  ...
  data() {
    return {
      data: {
        ...
        date: '2022-09-01',
        content: [
          'OFPAY（以下称 “公司”）是一家在新加坡注册成立的公司，该公司运营OFPAY APP（以下称“本平台”或“平台”），该平台是一个专门供用户进行数字资产交易和提供相关服务（以下称“该服务”或“服务”）的平台。为了表述之方便，公司和该平台在本协议中合称 “我们”或其他第一人称称呼，只要登录该平台的自然人或其他主体均为本平台的用户，以下使用“您”或其他第二人称，我们和您合称为“双方”，我们或您单称为“一方”。',
          ...
          '（二） 安全管理服务和服务信息推送服务',
          '当您使用本平台提供的服务或访问本平台时，本平台为保障您的交易安全及服务的安全稳定运行，我们需要自动接收并记录您的WOFB浏览器信息，您登录账户使用的设备类型、型号版本等设备识别符号等设备信息、您请求访问的网页上的IP地址及记录、所在地区、网络环境、设备指纹信息、服务日志信息、软件信息、位置信息等。',
