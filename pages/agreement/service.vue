  ...
  data() {
    return {
      data: {
        ...
        date: '2022-09-01',
        content: [
          '请仔细阅读《服务协议》(下称“本协议”)，本协议适用于用户访问和使用由OFPAY网址（以下简称“OFPAY”或 “我们”）提供的任何服务，包括但不限于网站OFPAY网址 （下称“OFPAY”或“本平台”）以及我们提供的移动应用客户端和钱包服务（统称为“本服务”）。',
          '用户在点击本平台的注册页面同意按钮并完成注册程序、获得本平台账号和密码时，即视为用户已知晓、理解并接受，同意本协议及本平台已经发布的或将来可能发布的所有的法律协议、操作规则及相关申明。所有规则、声明、说明为协议不可分割的一部分，与本协议正文具有同等法律效力。如果用户不同意受本协议的约束，请勿访问或使用本服务。请注意，OFPAY有权对本协议进行修改，恕不另行通知补发，请您定期查看本协议，因为您继续使用该平台将被视为是不可撤销的接受任何修订。本条款不涉及OFPAY用户与其他用户之间因数字资产交易而产生的法律关系及法律纠纷。为便利广大用户，本平台所有内容可能提供多个语言版本，若有冲突或遗漏等情况，以中文内容为准。',
          '重要提示：',
          '我们在此特别提醒您：',
