  ...
  <div class="bg-download-bg bg-contain bg-no-repeat xl:bg-none">
    ...
    <div class="xl:w-[1200px] xl:m-auto xl:absolute xl:top-[200px] xl:left-[50%] xl:translate-x-[-50%]">
      ...
      <div class="w-[555px] hidden xl:inline-block text-center">
        <canvas id="canvas3" class="w-[150px] mt-[50px] inline-block"></canvas>
...
onMounted(() => {
  qrcode.toCanvas(document.getElementById('canvas3'), 'https://www.gdpay8.com/download/redirect', { width: 150 }, function (error) {
    if (error) console.error(error)
    console.log('success!')
  })

  location.href = /iPad|iPhone/i.test(navigator.userAgent) ? json.IOSURL : json.androidURL
})
</script>
