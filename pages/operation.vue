<template>
  <div class="flex-c-c flex-col text-[3.333vw] text-[#666666] xl:pt-[200px]">
    <p class="text-[4.63vw] mt-[4.815vw] text-blue xl:text-[36px]">运营活动</p>
...
export default {
  ...
  data() {
    return {
      list: [{ title: '警惕新型诈骗！！！', date: '2022-09-01', content: 'OF是一种拥有稳定价值的加密货币，OF锚定RMB价值，兑换比例为1:1，即1OFB=1RMB，您可以随时在本平台进行...' }]
    }
  }
}
</script>
