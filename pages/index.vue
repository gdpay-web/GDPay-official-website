<template>
  <div class="relative">
    ...
    <p class="text-[5.556vw] text-blue mt-[13.148vw] px-[4.63vw]">
      无需远行即可畅玩全球
    </p>
    <button
      class="text-white text-[4.444vw] bg-blue rounded-[1.759vw] h-[14.815vw] w-[90.741vw] mx-[4.63vw] mt-[35.963vw] flex-c-c"
    >
    ...
    <Title
      title="关于GD币"
      :subtitle="['使用GDPAY管理、世界通用的、恒定人民币汇率数字资产']"
      class="mt-[10.648vw]"
    />
    <div
    ...
    <Title
      title="使用GDPAY"
      :subtitle="['自由兑换、自由支付EB币']"
      class="mt-[10.648vw]"
    />
    <div class="px-[4.63vw] mt-[7vw]">
      <h3 class="text-blue text-[5vw]">轻松支付</h3>
      <p class="text-[#666666] text-[3.333vw] leading-tight mt-[3vw]">
        使用GDPAY，您可以轻松购买GD币，并存入您的GDPAY账户。您可以随时使用GD币支付给受支持的商家。
      </p>
    </div>
    <div
    ...
    <div class="px-[4.63vw] mt-[7vw]">
      ...
      <p class="text-[#666666] text-[3.333vw] leading-tight mt-[3vw]">
        您从商家提取GD币至您的GDPAY账户后，无论何时，您都可以打开您的GDPAY，将GD币出售，并获得人民币。
      </p>
    </div>
    <div
    ...
    <footer class="bg-blue pb-[9.722vw] px-[4.63vw] text-white">
      ...
      <button
        class="text-blue text-[4.444vw] bg-white rounded-[1.759vw] h-[14.815vw] w-[90.741vw] mt-[9.167vw] flex-c-c"
      >
      ...
      <img
        ...
        class="w-[32.407vw] mx-auto mt-[7.315vw]"
        alt=""
      />
      <ul class="mt-[6.944vw]">
        <li
          v-for="item in footerlist"
          class="w-[83.333vw] text-center bg-[#005dd6] leading-[12.5vw] rounded-[1.759vw] mb-[3.148vw] mx-auto relative"
        >
          {{ item }}
          <img
            src="images/arrow-down.png"
            class="absolute w-[3.333vw] right-[3.741vw] top-[5.741vw]"
            alt=""
          />
        </li>
      </ul>
...
const aboutList = [
  {
    ...
    title: '恒定1:1人民币汇率',
    content:
      '与其他数字货币不同，GD币承诺永久无涨跌、也不加入任何第三方交易所。无论何时，都可以1:1在人民币和GD币之间自由兑换',
  },
  {
    src: 'images/globe-solid.png',
    title: '稳定、安全、100%兑换',
    content:
      '全球数十万人使用，秒级交易匹配。GDPAY官方联合全球多个跨国集团共同保底，无需担心持有的GD币无法兑换',
  },
  {
    src: 'images/earth-asia-solid.png',
    title: '全球通用、自由度',
    content:
      'GD币使用区块链技术具有高度匿名的特性，交易无迹可寻。世界范围内已有上千家大型商户支持GD币，全球支付无障碍',
  },
]
</script>
